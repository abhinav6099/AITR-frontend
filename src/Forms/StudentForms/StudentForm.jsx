    ...
    <div className="w-full bg-white border border-gray-200 rounded-lg shadow-md p-10">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <CalenderBox label="Date of Birth" name="dob" register={register} />
          ...
          <InputBox label="Year of Admission" name="admissionYear" register={register} />
          <InputBox label="Year of Graduation" name="graduationYear" register={register} />
          ...
          <InputBox label="Parent/Guardian Contact No" name="parentContact" register={register} />
          <InputBox label="Parent/Guardian Name" name="parentName" register={register} />
