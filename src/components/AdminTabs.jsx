      ...
      <div className="flex flex-wrap justify-center gap-3 mt-4">
        ...
        {tab === "Student" && (
          <Accordion label="Student" isOpen={true}>
            ...
            <Link to="/admin/hackathon-challenges">Hackathons</Link>
        ...
        {tab === "Institute" && (
          <Accordion label="Institute" isOpen={true}>
            <Link to="/admin/insititute/addinstitue-mous">MoU</Link>
            <Link to="/admin/insititute/addinstitute-counsultancy">Consultancy</Link>
            <Link to="/admin/insititute/addinstitute-eventgrant">Event Grant</Link>
            <Link to="/admin/insititute/addinstitute-documents">Institute Documents</Link>
            <Link to="/admin/insititute/addinstitute-r&dforms">R&D Forms</Link>
            <Link to="/admin/insititute/addinstitute-eventorganized">Event Organized</Link>
          </Accordion>
        )}

        {tab === "Department" && (
          <Accordion label="Department" isOpen={true}>
            <Link to="/admin/department/addmou">MoUs</Link>
            <Link to="/admin/department/addconsultancy-project">Consultancy Projects</Link>
            <Link to="/admin/department/addrd-inititatives">R&D Initiatives</Link>
            <Link to="/admin/department/addevent-grant-received">Event Grants Received</Link>
          </Accordion>
        )}
      </div>
    </nav>
